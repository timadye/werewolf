...
export function shuffleArray (array, npick=array.length, remove=false) {
...
export function initObject (keys, init=[]) {
  var obj = {};
...
export function keyArrayFromEntries (entries, init={}) {
  var ret = init;
...
export function keyArrayMap (obj, func, init={}) {
  var ret = init;
...
export function keyArrayAdd (obj, key, value) {
...
export function objectMap (obj, func, init={}) {
  var ret= init;
  if (Array.isArray (obj)) {
    var iter = obj;
  } else {
