...
function keyArrayFromEntries (entries, init={}) {
  var ret = init;
...
function keyArrayMap (obj, func, init={}) {
  var ret = init;
...
function keyArrayAdd (obj, key, value) {
...
function objectMap (obj, func, init={}) {
  var ret= init;
  if (Array.isArray (obj)) {
    var iter = obj;
  } else {
